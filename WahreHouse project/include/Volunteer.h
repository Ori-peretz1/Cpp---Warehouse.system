...
class Volunteer {
    public:
        ...
        virtual string toString() const = 0;//print the type of volunteer - collector,limited collector etc׳
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        void setTimeLeftToCoolDown(); // Our Additional. SET TimeLeft to CoolDown.
...
class LimitedCollectorVolunteer: public CollectorVolunteer {
    ...
    public:
        ...
        string toString() const override;
        void step() override; //additional func
...
class DriverVolunteer: public Volunteer {
    ...
    public:
        ...
        void setDistanceLeft(int distanceLeft);//additional method
        bool hasOrdersLeft() const override;
